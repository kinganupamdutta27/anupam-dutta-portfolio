...
urlpatterns = [
    ...
    path("listings/", views.PublicJobListView.as_view(), name="public_job_list"),
    path("listings/<slug:slug>/", views.PublicJobDetailView.as_view(), name="public_job_detail"),
    
    # User job management (requires login)
